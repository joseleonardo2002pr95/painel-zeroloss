...
import { Image, Type, Send, Trash2, ChevronUp, ChevronDown, Upload } from 'lucide-react';
            ...
            <div key={msg.id} className="message-block">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                ...
                <span style={{
                  ...
                  color: msg.type === 'text' ? '#60a5fa' : 'var(--color-green)',
                  background: msg.type === 'text' ? 'rgba(96,165,250,0.1)' : 'rgba(34,197,94,0.1)',
                  padding: '2px 8px', borderRadius: 4,
                }}>
                  {msg.type === 'text' ? <Type size={11} /> : <Image size={11} />}
                  {msg.type === 'text' ? 'Texto' : 'Imagem'}
                </span>
